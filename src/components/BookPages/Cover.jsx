...
export default function Cover({title, subheading, year, services, image, description, color}) {
    return (
        <div className="flex flex-col justify-center items-end">
            <div className="md:w-11/12 w-10/12 h-full ">
...
>
                    <div className="aspect-square relative flex items-end justify-end"
                         style={
                             {backgroundColor: color}
                         }>
                            <img src={image}
                                 className="cursor-pointer mx-auto object-cover aspect-square w-full shadow-lg  "
                            />
